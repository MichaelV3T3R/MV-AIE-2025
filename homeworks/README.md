...
Каждое задание оформлено в отдельной папке:
...
Внутри каждой папки хранится как минимум **одно основное задание** в виде ноутбука Jupyter с тем же номером, что и папка.
